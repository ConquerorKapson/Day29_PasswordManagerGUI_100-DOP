...
email_entry = Entry(width=43, font=ENTRY_FONT)
email_entry.grid(row=2, column=1, sticky=W)
password_entry = Entry(width=43, font=ENTRY_FONT)
password_entry.grid(row=3, column=1, sticky=W, columnspan=1)

search_password_button = Button(text="Search", font=BUTTON_FONT, width=15, command=find_password)
